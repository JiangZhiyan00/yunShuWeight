...
public class HuZhouWeightJourHandler implements IBaseHandler {
     ...
     * redis的key前缀
     */
    private static final String YUNSHU_OVERWEIGHT_PREFIX = "YUNSHU:OVERWEIGHT:HUZHOU:";
    ...
    public void doHandle() {
        try {
            // 1.先查库
            List<WeightJour> weightJours = weightJourMapper.queryOverWeightListByCenter("湖州管理中心");
